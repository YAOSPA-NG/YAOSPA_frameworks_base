...
//                UserHandle.USER_CURRENT) == 1);
    ...
    public class ProximitySensor implements SensorEventListener {
        ...
        // Maximum time for the hand to cover the sensor: 500ms
        private static final float HANDWAVE_MAX_DELTA_S = 0.5f;

        // Minimum time until the device is considered to have been in the pocket: 30s
        private static final float POCKET_MIN_DELTA_S = 30.0f;
